Shader "Sprites/DefaultColorFlash"
{
  Properties
  {
    ...
    _FillAlpha ("Flash Amount", Range(0, 1)) = 0
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xyz = (-u_xlat10_0.xyz) * in_f.color.xyz + _FlashColor.xyz;
          
          u_xlat0_d = u_xlat10_0 * in_f.color;
          
          u_xlat0_d.xyz = float3(_FillAlpha) * u_xlat1_d.xyz + u_xlat0_d.xyz;
